    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-8">
          <div class="card">
            <div class="header">
              <h4 class="title">Edit a Safe Zone</h4>
            </div>
            <div class="content">
              {!! Form::model($safezone, ['METHOD'=>'POST','url' => route('admin.safezones.update', $safezone->id)]) !!}
              ...
              <div class="form-group {{ $errors->has('radius') ? ' has-error' : '' }}">
                <label class="col-md-44 control-label">Radius</label>
                <div class="col-md-66">
